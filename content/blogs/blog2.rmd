...
To study climate change, I used the data on the *Combined
Land-Surface Air and Sea-Surface Water Temperature Anomalies* in the
Northern Hemisphere from [NASA's Goddard Institute for Space
...
Next, I'll the data using a time-series scatter plot, and add a
trend line.
...
I remove the data before 1800 using `filter`. Then, I use the
